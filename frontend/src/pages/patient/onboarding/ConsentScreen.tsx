...
export default function ConsentScreen() {
  ...
  return (
    <div className="max-w-2xl mx-auto mt-10 p-6 bg-white rounded-lg shadow-md">
      <h2 className="text-2xl font-bold text-foreground mb-6">Informed Consent</h2>
      
      <div className="prose prose-sm text-gray-700 mb-6 max-h-96 overflow-y-auto p-4 border border-[#e8e4df] rounded">
        ...
        <p>You may discontinue use of this service or request your data be deleted at any point by contacting our support team.</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <label className="flex items-start space-x-3">
          <input 
            ...
            className="mt-1 h-5 w-5 text-accent focus:ring-accent rounded border-gray-300"
          />
        ...
        <div className="pt-4">
          <button
            type="submit"
            disabled={loading}
            className="w-full py-2 px-4 border border-transparent rounded-md shadow-sm text-white bg-accent hover:bg-teal-700 focus:outline-none disabled:opacity-50"
          >
